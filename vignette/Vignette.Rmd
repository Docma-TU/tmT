...
The function \texttt{makeClear} deletes all \texttt{meta} entries which did not belong to one of the texts (e.g. deleted empty texts).
...
After preprocessing the text data there is a typical workflow we recommend for looking at the corpus. This workflow contains the generic functions \texttt{print} and \texttt{summary} as well as the highly adaptable functions \texttt{plotScot} and \texttt{plotWord}. These graphical functions should be part of any initial analysis of text data.
