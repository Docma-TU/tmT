...
## Write CSV Files - \texttt{showTexta}, \texttt{showMeta}
...
<!-- After identifying the top pages it is possible to have a deeper look at these articles. Therefore the mentioned function \texttt{showTexta} can be used. The returned value is a list with three entries with \texttt{data.frames} of four rows - the different pages - and four columns each - \textit{id}, \textit{title}, \textit{date} and \textit{text}. For displaying, the fourth column of each \texttt{data.frame} containing the pages content itself is removed. -->
<!-- ```{r} -->
<!-- topArt = showTexta(corpusFiltered, id = topID) -->
