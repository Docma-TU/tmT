...
## (print("<i>"))
## x <- lapply(x,function(x){gsub(pattern="<i>", replacement=" ",x)})
## x <- lapply(x,function(x){gsub(pattern="</i>", replacement=" ",x)})
## (print("<b>"))
## x <- lapply(x,function(x){gsub(pattern="<b>", replacement=" ",x)})
## x <- lapply(x,function(x){gsub(pattern="</b>", replacement=" ",x)})
## (print("<br/>"))
## x <- lapply(x,function(x){gsub(pattern="<br/>", replacement=" ",x)})
## (print("<I>"))
## x <- lapply(x,function(x){gsub(pattern="<I>", replacement=" ",x)})
## x <- lapply(x,function(x){gsub(pattern="</I>", replacement=" ",x)})
## (print("<B>"))
