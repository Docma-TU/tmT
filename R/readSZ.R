...
mData <- data.frame(id,datum,rubrik,seite,AnzChar,AnzWoerter,dachzeile,titel,zwischentitel,untertitel, stringsAsFactors = FALSE)
...
if(do.text){
    ...
    text_neu <- gsub(pattern="<AUTHOR>.*?</AUTHOR>", replacement=" ",x=text_neu, perl=TRUE)
