...
#' Additionally the corpora are reduced by \code{\link{subcorpusWord}} and an
...
#' @param search see \code{\link{subcorpusWord}}
#' @param ignore.case see \code{\link{subcorpusWord}}
...
plotWordSub = function(object, ldaresult, ldaID, limit = 10,
  ...
  # create textmeta with text-component as result of subcorpusWord (mention
  ...
  subids <- lapply(subs, function(object)
    names(object$text)[subcorpusWord(text = object$text,
