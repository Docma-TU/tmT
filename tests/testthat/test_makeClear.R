...
expect_equal(makeClear(text = text, sw = "de", paragraph=FALSE), mc1)
expect_equal(makeClear(text = text2, sw = "de", paragraph=TRUE), mc2)
...
cleared <- makeClear(object = tm, sw = "de", paragraph = TRUE)
