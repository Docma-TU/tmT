...
text2 <- list("aba<vcs>ab</vcs>caa", "ab&dgv;abc", iconv(c("הצüßײִÜ"), from="latin1", to="UTF-8"), c("aa", "aab", "bc"))

expect_equal(removeXML(x=text2, umlaute = FALSE, u.type = c("normal", "html", "all")), list(c("aba ab caa"),c("ab&dgv;abc"),iconv(c("הצüßײִÜ"), from="latin1", to="UTF-8") ,c("aa",  "aab", "bc")))
