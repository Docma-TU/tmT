...
text2 <- list("aba<vcs>ab</vcs>caa", "ab&dgv;abc", c("äöüßÖÄÜ"), c("aa", "aab", "bc"))

expect_equal(removeXML(x=text2, umlaute = FALSE, u.type = c("normal", "html", "all")), list(c("aba ab caa"),c("ab&dgv;abc"),c("äöüßÖÄÜ") ,c("aa",  "aab", "bc")))
