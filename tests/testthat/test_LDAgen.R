...
counttest <- LDAgen(documents=LDAdoc, K = 3L, vocab=wordlist$words, num.iterations = 20L, burnin = 70L, seed=24602, folder=tempdir(), num.words = 10L, LDA = TRUE, count=TRUE)
csvTest2 <- read.csv(paste0(tempdir(),"/test-k3i20b70s24602alpha0.33eta0.33.csv"))
