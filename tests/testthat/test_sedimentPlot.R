...
test_that("sedimentPlot", {
    ...
    expect_equal(sP1, sedimentPlot(x=x, ldaID=ldaID, usedTopics=NULL, label=NULL, threshold=NULL, meta=meta1, unit="month", xunit="year", color=NULL, sort=TRUE, legend="topleft", legendLimit=0, peak=0.2))
    expect_equal(sP2, sedimentPlot(x=x, ldaID=ldaID, usedTopics=c(2,4,7), label=NULL, threshold=NULL, meta=meta1, unit="month", xunit="month", color=NULL, sort=TRUE, legend="topleft", legendLimit=0, peak=0))
