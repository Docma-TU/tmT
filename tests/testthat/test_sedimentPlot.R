...
test_that("sedimentPlot", {
    ...
    expect_equal(sP1, sedimentPlot(x=x, ldaID=ldaID, usedTopics=NULL, label=NULL, threshold=NULL, meta=meta1, unit="month", xunit="year", color=NULL, sort=TRUE, legend="topleft", legendLimit=0, peak=0))
