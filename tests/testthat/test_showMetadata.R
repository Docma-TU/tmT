...
test_that("showMetadata", {
    ...
    expect_equal(showMetadata(meta=meta, file="test", id = as.character(c(1,3)), cols = colnames(meta), csv.ger = FALSE), meta[c(1,3),])
    expect_equal(showMetadata(meta=meta, file="test", cols = colnames(meta), csv.ger = TRUE), meta)
})
