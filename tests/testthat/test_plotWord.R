...
test_that("plotWord", {
  ...
  tab = plotWord(tm, id = id, wordlist = c("tu", "dortmund"))
  ...
  expect_equal(tab$dortmund, c(2, 8, 9, 11, 11, 3, 7, 5, 6, 11, 16, 11, 11, 13,
    ...
    4, 4, 4))
  expect_equal(plotWord(tm, id = id, wordlist = c("tu", "dortmund"),
  ...
  expect_equal(plotWord(tm, id = id, wordlist = list(c("tu", "dortmund")),
  ...
  expect_equal(plotWord(tm, id = id, wordlist = list(c("tu", "dortmund")),
    ...
    c(0.196395613939855, 0.197667686709122, 0.19914853358562, 0.203381660424932,
      ...
      0.197523863528967))
  expect_error(plotWord(object = tm$meta))
  expect_error(plotWord(tm))
})
